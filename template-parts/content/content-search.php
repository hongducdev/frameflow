...
$archive_readmore_text = frameflow()->get_theme_opt('archive_readmore_text', esc_html__('Continue Reading', 'frameflow'));
                        ...
                        ?>
                            <a class="btn-more" href="<?php echo esc_url(get_permalink()); ?>">
                                <span><svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 14 14" fill="none">
                                        <path d="M0.75 12.4167L12.4167 0.75M12.4167 0.75H0.75M12.4167 0.75V12.4167" stroke="white" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                    </svg></span>
                            </a>
                        <?php } ?>
                    </div>
