            ...
            'sections' => array(
                array(
                    ...
                    'controls' => array(
                        array(
                            'name' => 'source_type',
                            'label' => esc_html__('Source Type', 'frameflow'),
                        ...
                        array(
                            'name' => 'image',
                            'label' => esc_html__('Choose Image', 'frameflow'),
                        ...
                        array(
                            'name' => 'image_type',
                            'label' => esc_html__('Image Type', 'frameflow'),
                            'type' => \Elementor\Controls_Manager::SELECT,
                            'options' => [
                                'img' => 'Image',
                                'bg' => 'Background',
                ...
                array(
                    ...
                    'controls' => array(
                        ...
                        array(
                            ...
                            'size_units' => ['px'],
                            'selectors' => [
                                '{{WRAPPER}} .pxl-image-single img, {{WRAPPER}} .pxl-item--inner, {{WRAPPER}} .pxl-item--bg, {{WRAPPER}} .hover-imge-ripple' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                            ],
                        ),
                        array(
                            'name' => 'border_type',
                            ...
                            'selectors' => [
                                '{{WRAPPER}} .pxl-image-single img, {{WRAPPER}} .hover-imge-ripple' => 'border-style: {{VALUE}} !important;',
                            ],
                        ),
                        array(
                            'name' => 'border_width',
                            ...
                            'type' => \Elementor\Controls_Manager::DIMENSIONS,
                            'selectors' => [
                                '{{WRAPPER}} .pxl-image-single img, {{WRAPPER}} .hover-imge-ripple' => 'border-width: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}} !important;',
                            ],
                            'condition' => [
                                'border_type!' => '',
                            ],
                        ...
                        array(
                            ...
                            'default' => '',
                            'selectors' => [
                                '{{WRAPPER}} .pxl-image-single img, {{WRAPPER}} .hover-imge-ripple' => 'border-color: {{VALUE}} !important;',
                            ],
                            'condition' => [
                                'border_type!' => '',
                            ],
                        ...
                        array(
                            ...
                            'control_type' => 'group',
                            'selector'     => '{{WRAPPER}} .pxl-image-single img, {{WRAPPER}} .hover-imge-ripple'
                        ),
                        array(
                            'name' => 'img_effect',
                            'label' => esc_html__('Image Effect', 'frameflow'),
                            'type' => \Elementor\Controls_Manager::SELECT,
                            'options' => [
                                '' => 'None',
                        ...
                        array(
                            ...
                            'label' => esc_html__('Parallax Scroll Type', 'frameflow'),
                            'type' => \Elementor\Controls_Manager::SELECT,
                            'options' => [
                                'y' => 'Effect Y',
                                'x' => 'Effect X',
                        ...
                        array(
                            ...
                            'label' => esc_html__('Parallax Value', 'frameflow'),
                            'type' => \Elementor\Controls_Manager::TEXT,
                            'condition' => [
                                'img_effect' => 'pxl-parallax-scroll',
                            ],
                        ...
                        array(
                            'name' => 'show_ripple',
                            'label' => esc_html__('Show Ripple', 'frameflow'),
